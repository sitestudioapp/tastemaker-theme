 ...
 * @return void
 */
function tastemaker_register_block_patterns() {
	...
	register_block_pattern_category(
		'theme',
		array( 'label' => esc_html__( 'Theme patterns', 'tastemaker' ) )
	);

}
add_action( 'init', 'tastemaker_register_block_patterns', 9 );
 ...
 * @return void
 */
function tastemaker_unregister_patterns() {
	unregister_block_pattern( 'core/query-small-posts' );
	unregister_block_pattern( 'core/query-large-title-posts' );
	unregister_block_pattern( 'core/query-offset-posts' );
	unregister_block_pattern_category( 'featured' );
}
add_action( 'init', 'tastemaker_unregister_patterns', 10 );
